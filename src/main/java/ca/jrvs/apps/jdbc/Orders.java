...
public class Orders implements DataTransferObject {
    ...
    public Date getCreationDate(java.sql.Date date) {
        return creationDate;
    }
    ...
    public BigDecimal getTotalDue(BigDecimal bigDecimal) {
        return totalDue;
    }
    ...
    public String getSalespersonFirstName(String string) {
    ...
    public String getSalespersonLastName(String string) {
    ...
    public String getSalespersonEmail(String string) {
